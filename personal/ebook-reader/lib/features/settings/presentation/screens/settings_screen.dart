      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            onTap: () => context.pushNamed(RouteNames.readingSettings),
          ),
          ListTile(
            ...
            trailing: const Icon(Icons.chevron_right),
            onTap: () => context.pushNamed(RouteNames.displaySettings),
          ),
          ListTile(
            ...
            trailing: const Icon(Icons.chevron_right),
            onTap: () => context.pushNamed(RouteNames.gestureSettings),
          ),
          ListTile(
            ...
            trailing: const Icon(Icons.chevron_right),
            onTap: () => context.pushNamed(RouteNames.ttsSettings),
          ),
          ...
          ListTile(
            ...
            trailing: const Icon(Icons.chevron_right),
            onTap: () => context.pushNamed(RouteNames.syncSettings),
          ),
