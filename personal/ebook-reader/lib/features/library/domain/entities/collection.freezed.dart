...
class _$CollectionImpl implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(id: $id, name: $name, description: $description, coverPath: $coverPath, createdAt: $createdAt, bookCount: $bookCount)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, description, coverPath, createdAt, bookCount);
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      final int bookCount}) = _$CollectionImpl;
